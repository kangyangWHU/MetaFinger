...
__all__ = ['resnet18_cifar10',"resnet18_tinyimagenet",'resnet34_cifar10','resnet50_cifar10']
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
        ...
        # Zero-initialize the RTLL BN in each residual branch,
        # so that the residual branch starts with zeros, and each residual block behaves like an identity.
        # This improves the nets by 0.2~0.3% according to https://arxiv.org/abs/1706.02677
...
@mlconfig.register
def resnet18_tinyimagenet(**kwargs):
